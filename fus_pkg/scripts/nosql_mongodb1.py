...
def left_image_callback(msg):
    image_data = {
        ...
        'width': msg.width,
        'step': msg.step,
        'data': list(msg.data)  # 将图像数据存储为list
    }
    insert_data(collection_sensors, {'type': 'left_image', 'data': image_data})
...
def right_image_callback(msg):
    ...
    insert_data(collection_sensors, {'type': 'right_image', 'data': image_data})
